...
class __$$GetPostImplCopyWithImpl<$Res>
    extends _$PostDetailEventCopyWithImpl<$Res, _$GetPostImpl>
...
class _$GetPostImpl implements _GetPost {
  const _$GetPostImpl(this.postId);
  ...
  @override
  String toString() {
    return 'PostDetailEvent.getPost(postId: $postId)';
  }
...
abstract class _GetPost implements PostDetailEvent {
  const factory _GetPost(final String postId) = _$GetPostImpl;
